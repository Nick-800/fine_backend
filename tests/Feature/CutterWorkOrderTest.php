...
beforeEach(function () {
    ...
    $this->pieceItem = InventoryItem::create([
        'name' => 'Cut Template Piece', 'sku' => 'PIECE-1', 'item_type' => 'cut_template_piece', 'unit_of_measure' => 'each',
    ]);
    $this->fillItem = InventoryItem::create([
        'name' => 'Byproduct Fill', 'sku' => 'FILL-1', 'item_type' => 'byproduct_fill', 'unit_of_measure' => 'kg',
    ]);
